...
export const Modal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
      ...
      <div
        className={cn(
          'relative w-full rounded-2xl bg-slate-900/95 border border-slate-700/60 shadow-2xl shadow-black/80 overflow-hidden z-10 my-8 transition-all transform animate-scaleUp',
